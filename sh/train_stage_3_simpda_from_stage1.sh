#!/bin/bash
#SBATCH --job-name=train_stage_3_simpda_from_stage1       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpda_from_stage1 \
    ...
    --save_epoch 10 \
    --head_type linear \
    --checkpoint ../results/checkpoints/stage_1_3e-5_linear/lr3e-05_3_5758_0.08720021694898605.bin
echo "FINISH"                       # 输出起始信息
