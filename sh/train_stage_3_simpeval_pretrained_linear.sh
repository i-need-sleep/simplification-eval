#!/bin/bash
#SBATCH --job-name=train_stage_3_simpeval_pretrained_linear       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpeval_pretrained_linear \
    --stage finetune_simpeval \
    --lr 3e-7 \
    --batch_size 10 \
    --batch_size_dev 5 \
    --n_epoch 100 \
    --checkpoint ../results/checkpoints/stage_2_3e-5_linear_from_stage1/lr3e-05_40_563_0.09335407614707947.bin \
    --save_epoch 5 \
    --head_type linear
echo "FINISH"                       # 输出起始信息
