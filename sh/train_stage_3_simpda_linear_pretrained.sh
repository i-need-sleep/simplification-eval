#!/bin/bash
#SBATCH --job-name=train_stage_3_simpda_linear_pretrained       # 任务名
...
python -u train_deberta.py \
    --name finetune_simpda_linear_pretrained \
    ...
    --save_epoch 10 \
    --head_type linear \
    --checkpoint ../results/checkpoints/stage_2_3e-6_from_stage1_linear/lr3e-06_0_563_0.32360395789146423.bin
echo "FINISH"                       # 输出起始信息
