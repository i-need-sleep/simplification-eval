#!/bin/bash
#SBATCH --job-name=train_stage_3_simpeval_linear_from_stage2       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpeval_3e-7_linear_from_stage2 \
    ...
    --save_epoch 5 \
    --head_type linear \
    --checkpoint ../results/checkpoints/stage_2_3e-5_linear/lr3e-05_56_563_0.09472865611314774.bin
echo "FINISH"                       # 输出起始信息
