#!/bin/bash
#SBATCH --job-name=train_stage_3_simpda_simplicity_from_stage1       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpda_simplicity_from_stage1 \
    --stage finetune_simpda_simplicity \
    --lr 3e-5 \
    --batch_size 10 \
    --batch_size_dev 5 \
    --n_epoch 20 \
    --checkpoint ../results/checkpoints/stage_1_3e-5/lr3e-05_24_602_0.23161783814430237.bin
echo "FINISH"                       # 输出起始信息
