#!/bin/bash
#SBATCH --job-name=train_stage_3_simpda_from_stage12       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpda_from_stage12 \
    ...
    --save_epoch 10 \
    --head_type linear \
    --checkpoint ../results/checkpoints/dated/stage_1_3e-5_linear/lr3e-05_2_5758_0.08522509783506393.bin
echo "FINISH"                       # 输出起始信息
