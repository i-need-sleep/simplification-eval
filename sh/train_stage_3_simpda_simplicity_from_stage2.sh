#!/bin/bash
#SBATCH --job-name=train_stage_3_simpda_simplicity_from_stage2       # 任务名
...
python -u train_deberta.py \
    --name train_stage_3_simpda_simplicity_from_stage2 \
    --stage finetune_simpda_simplicity \
    --lr 3e-5 \
    --batch_size 10 \
    --batch_size_dev 5 \
    --n_epoch 20 \
    --checkpoint ../results/checkpoints/stage_2_3e-5/lr3e-05_44_563_0.09606735408306122.bin
echo "FINISH"                       # 输出起始信息
